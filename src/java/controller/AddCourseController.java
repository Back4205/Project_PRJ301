...
public class AddCourseController extends HttpServlet {
    ...
    String category_raw = request.getParameter("category");
        ...
        try {
            ...
            Course p = new Course(title, description, price, admin, category, thumbnail, createDate);
            boolean check = dao.insertCourse(title, p);
            if (check) {
                response.sendRedirect("ListCourseController");
            } else {
                request.setAttribute("error", "Khóa học đã tồn tại hoặc thêm thất bại");
