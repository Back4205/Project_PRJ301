 ...
 * @author Vuong Bach
 */
@WebServlet(name="MyCoursesController", urlPatterns={"/MyCoursesController"})
public class MyCoursesController extends HttpServlet {
   ...
   @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Course> courseList = enrollDAO.getEnrolledCourses(userID);

        System.out.println("🟢 MyCoursesController -> userID=" + userID + ", courseList=" + courseList.size());
